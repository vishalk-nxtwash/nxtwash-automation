...
def test_wash_books_loads(browser):
    ...
    assert page_is_up(browser)
    assert "Wash books" in page.get_body_text(), "Wash Books page title not found"
...
def test_wash_extras_loads(browser):
    ...
    assert page_is_up(browser)
    assert "wash extras" in page.get_body_text().lower(), "Wash Extras page title not found"
...
def test_gift_cards_loads(browser):
    ...
    assert page_is_up(browser)
    assert "Gift card" in page.get_body_text(), "Gift Cards page title not found"
...
def test_coupon_packages_loads(browser):
    ...
    assert page_is_up(browser)
    assert "Coupon packages" in page.get_body_text(), "Coupon Packages page title not found"
...
def test_bank_drop_loads(browser):
    ...
    assert page_is_up(browser)
    assert "Bank drop" in page.get_body_text(), "Bank Drop page title not found"

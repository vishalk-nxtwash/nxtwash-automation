...
def test_employees_page_loads(browser):
    ...
    assert page_is_up(browser)
    assert "Employees" in page.get_body_text(), "Employees page title not found"
...
def test_users_page_loads(browser):
    ...
    assert page_is_up(browser)
    assert "Users" in page.get_body_text(), "Users page title not found"
...
def test_user_roles_page_loads(browser):
    ...
    assert page_is_up(browser)
    assert "User roles" in page.get_body_text(), "User Roles page title not found"

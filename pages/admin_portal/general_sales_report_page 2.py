...
class AdminGeneralSalesReportPage(BasePage):
    ...
    def clear_site_selection(self):
        """Remove all selected site chips to revert to All Sites."""
    ...
    def get_site_options(self):
        ...
        time.sleep(0.5)
        options = self.driver.execute_script(self._COLLECT_OPTIONS_JS)
        try:
    ...
    def enter_custom_date_range(self, start, end):
        """Type MM/DD/YYYY - MM/DD/YYYY into the single date range text input."""
    ...
    def apply_filters(self):
        ...
        try:
            ...
            pass
        # Re-enter the iframe after the report reloads — without this, the next
        # driver interaction searches default_content and times out.
        self._switch_to_frame()

#!/usr/bin/env bash
# Shard 1: bank_drop, login, service_categories, gift_cards, wash_extras, wash_activity, coupon_packages
set -euo pipefail
...
MODULES=(bank_drop login service_categories gift_cards wash_extras wash_activity coupon_packages)
